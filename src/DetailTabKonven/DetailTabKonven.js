...
import DetailTabKonvenList from '../DetailTabKonven/DetailTabKonvenList';
...
function DetailTabKonvenContent() {
...
export default function DetailTabKonven() {
  return <DetailTabKonvenContent />;
}