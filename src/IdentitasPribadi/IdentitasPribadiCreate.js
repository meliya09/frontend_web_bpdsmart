...
export default function IdentitasPribadiCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/identitas', {
            ...
            .then(res => {
                ...
                window.location.href = "/identitaspribadi";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Identitas </DialogTitle>
                <DialogContent>
