...
import ProdukSyariahUpdate from '../ProdukSyariah/ProdukSyariahUpdate';
...
function ProdukSyarUpdateContent() {
...
export default function SyariahUpdateContent() {
  return <ProdukSyarUpdateContent />;
}