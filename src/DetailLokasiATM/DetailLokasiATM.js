...
import DetailLokasiATMList from '../DetailLokasiATM/DetailLokasiATMList';
...
function DetailLokasiATMContent() {
...
export default function DetailLokasiATM() {
  return <DetailLokasiATMContent />;
}