...
export default function InternalCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/internal', {
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Internal</DialogTitle>
                <DialogContent>
