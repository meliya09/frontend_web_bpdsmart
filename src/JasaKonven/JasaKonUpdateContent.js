...
import JasaKonvenUpdate from '../JasaKonven/JasaKonvenUpdate';
...
function JasaKonvenUpdateContent() {
...
export default function JasaKonUpdateContent() {
  return <JasaKonvenUpdateContent />;
}