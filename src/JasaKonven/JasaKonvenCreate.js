...
export default function JasaKonvenCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/jasakonven', {
            ...
            .then(res => {
                ...
                window.location.href = "/jasakonven";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Jasa Konven</DialogTitle>
                <DialogContent>
