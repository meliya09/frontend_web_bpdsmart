...
import KreditProgramCreate from "./KreditProgramCreate";
...
export default function KreditProgramList() {
  const classes = useStyles();
  const navigate = useNavigate();
  const [dbo_konten, setKreditProgram] = useState([]);
  ...
  const getKreditProgram = async () => {
    const dbo_konten = await axios.get("http://192.168.100.215:8080/kreditprogram");
    setKreditProgram(dbo_konten.data);
  }

  const getDetail = async (id) => {
    navigate(`/kreditprogram/detailkreditprogram/${id}`);
  };

  const UpdateKreditProgram = async (id) => {
    navigate(`/updatekreditprogram/${id}`);
  };
  ...
  const KreditProgramDelete = async (id) => {
    await axios.delete(`http://192.168.100.215:8080/kreditprogram/${id}`);
    getKreditProgram();
  };
              ...
              <Paper>
                <Box>
                  ...
                  >
                    ...
                    <KreditProgramCreate create={create} handleCloseCreate={handleCloseCreate} />
                        ...
                        >
                          ...
                          <TableCell align="center">
                            <ButtonGroup color="primary" aria-label="outlined primary button group">
                              ...
                              <Button startIcon={<EditIcon />} color="success" onClick={() => UpdateKreditProgram(konven.konten_id)}>
                              </Button>
                              ...
                              <Button startIcon={<DeleteIcon />} color="error"
                                onClick={() =>
                                  swal({
                                    ...
                                    if (result) {
                                      KreditProgramDelete(konven.konten_id);
                                      swal({
                                        title: "Deleted!",
