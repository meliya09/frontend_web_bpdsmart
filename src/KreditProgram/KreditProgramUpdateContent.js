...
import KreditProgramUpdate from '../KreditProgram/KreditProgramUpdate';
...
function KreditProUpdateContent() {
...
export default function KreditProgramUpdateContent() {
  return <KreditProUpdateContent />;
}