...
import DanaSyariahUpdate from '../DanaSyariah/DanaSyariahUpdate';
...
function DanaSyarUpdateContent() {
...
export default function DanaSyariahUpdateContent() {
  return <DanaSyarUpdateContent />;
}