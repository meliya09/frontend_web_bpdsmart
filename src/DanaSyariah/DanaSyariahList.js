...
import DanaSyariahCreate from "./DanaSyariahCreate";
...
export default function DanaSyariahList() {
  const classes = useStyles();
  const navigate = useNavigate();
  const [dbo_konten, setDanaSyariah] = useState([]);
  ...
  const getDanaSyariah = async () => {
    const dbo_konten = await axios.get('http://192.168.100.215:8080/danasyariah');
    setDanaSyariah(dbo_konten.data);

  }

  const DanaSyariahUpdate = async (id) => {
    navigate(`/updatedanasyariah/${id}`);
  };

  const DanaSyariahDelete = async (id) => {
    await axios.delete(`http://192.168.100.215:8080/danasyariah/${id}`);
    getDanaSyariah();
  };
              ...
              <Paper>
                <Box>
                  ...
                  >
                    ...
                    <DanaSyariahCreate create={create} handleCloseCreate={handleCloseCreate} />
                        ...
                        >
                          ...
                          <TableCell align="center">
                            <ButtonGroup color="primary" aria-label="outlined primary button group">
                              ...
                              <Button startIcon={<EditIcon />} color="success" onClick={() => DanaSyariahUpdate(syariah.konten_id)} >
                              </Button>
                              <Button startIcon={<DeleteIcon />} color="error"
                                onClick={() =>
                                  swal({
                                    ...
                                    if (result) {
                                      DanaSyariahDelete(syariah.konten_id);
                                      swal({
                                        title: "Deleted!",
