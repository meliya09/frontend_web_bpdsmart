...
export default function DanaSyariahCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/danasyariah', {
            ...
            .then(res => {
                ...
                window.location.href = "/danasyariah";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Dana Syariah</DialogTitle>
                <DialogContent>
