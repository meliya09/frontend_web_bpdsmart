...
import JasaSyariahCreate from "./JasaSyariahCreate";
...
export default function JasaSyariahList() {
  const classes = useStyles();
  const navigate = useNavigate();


  const [dbo_konten, setJasaSyariah] = useState([]);

  useEffect(() => {
    getJasaSyariah();
  }, []);

  const getJasaSyariah = async () => {
    const dbo_konten = await axios.get('http://192.168.100.215:8080/jasasyariah');
    setJasaSyariah(dbo_konten.data);
  ...
  const UpdateJasaSyariah = async (id) => {
    navigate(`/updatejasasyariah/${id}`);
  };

  const JasaSyariahDelete = async (id) => {
    await axios.delete(`http://192.168.100.215:8080/jasasyariah/${id}`);
    getJasaSyariah();
  };
  const getDetail = async (id) => {
    navigate(`/jasasyariah/detailjasasyariah/${id}`);
  };
              ...
              <Paper>
                <Box>
                  ...
                  >
                    ...
                    <JasaSyariahCreate create={create} handleCloseCreate={handleCloseCreate} />
                        ...
                        >
                          ...
                          <TableCell align="center">
                            <ButtonGroup color="primary" aria-label="outlined primary button group">
                              ...
                              <Button startIcon={<EditIcon />} color="success" onClick={() => UpdateJasaSyariah(syariah.konten_id)} >
                              </Button>
                              ...
                              <Button startIcon={<DeleteIcon />} color="error"
                                onClick={() =>
                                  swal({
                                    ...
                                    if (result) {
                                      JasaSyariahDelete(syariah.konten_id);
                                      swal({
                                        title: "Deleted!",
                      ...
                      >
                        ...
                        {(() => {
                          if (syariah.kategori_nama == 'Produk') {
                            return (
                              <TableCell align="center">
                                <Stack spacing={7.5} direction="row" >
