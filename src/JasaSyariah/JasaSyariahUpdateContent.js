...
import JasaSyariahUpdate from '../JasaSyariah/JasaSyariahUpdate';
...
function JasaSyarUpdateContent() {
...
export default function JasaSyariahUpdateContent() {
  return <JasaSyarUpdateContent />;
}