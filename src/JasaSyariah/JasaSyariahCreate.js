...
export default function JasaSyariahCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/jasasyariah', {
            ...
            .then(res => {
                ...
                window.location.href = "/jasasyariah";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Jasa Syariah</DialogTitle>
                <DialogContent>
