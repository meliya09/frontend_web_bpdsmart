...
import DepositoSyariahCreate from "./DepositoSyariahCreate";
...
export default function DepositoSyariahList() {
  ...
  const getDepositoSyariah = async () => {
    const dbo_konten = await axios.get('http://192.168.100.215:8080/depositosyariah');
    setSyariah(dbo_konten.data);

  }

  // const editDepositoSyariah = async () => {
  //   const dbo_konten = await axios.get('http://192.168.100.215:8080/depositosyariah/:id')
  //   setSyariah(dbo_konten.data);

  // }

  const UpdateDepositoSyariah = async (id) => {
    navigate(`/updatedepsyariah/${id}`);
  };

  const DepositoSyariahDelete = async (id) => {
    await axios.delete(`http://192.168.100.215:8080/depositosyariah/${id}`);
    getDepositoSyariah();
  };

  const getDetail = async (id) => {
    navigate(`/depositosyariah/detaildeposyariah/${id}`);
  };
              ...
              <Paper>
                <Box>
                  ...
                  >
                    ...
                    <DepositoSyariahCreate create={create} handleCloseCreate={handleCloseCreate} />
                        ...
                        >
                          ...
                          <TableCell align="center">
                            <ButtonGroup color="primary" aria-label="outlined primary button group">
                              ...
                              <Button startIcon={<EditIcon />} color="success" onClick={() => UpdateDepositoSyariah(syariah.konten_id)}>
                              </Button>
                              ...
                              <Button startIcon={<DeleteIcon />} color="error"
                                onClick={() =>
                                  swal({
                                    ...
                                    if (result) {
                                      DepositoSyariahDelete(syariah.konten_id);
                                      swal({
                                        title: "Deleted!",
