...
import DepositoSyariahList from '../DepositoSyariah/DepositoSyariahList';
...
function DepositoSyariahContent() {
...
export default function DepositoSyariah() {
  return <DepositoSyariahContent />;
}