...
export default function DepositoSyariahCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/depositosyariah', {
            ...
            .then(res => {
                ...
                window.location.href = "/depositosyariah";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Deposito Syariah</DialogTitle>
                <DialogContent>
