...
export default function LokasiATMCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/lokasiatm', {
            ...
            .then(res => {
                ...
                window.location.href = "/lokasiatm";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Lokasi ATM</DialogTitle>
                <DialogContent>
