...
import LokasiATMUpdate from '../LokasiATM/LokasiATMUpdate';
...
function LokasiAtmUpdateContent() {
...
export default function LokasiATMUpdateContent() {
  return <LokasiAtmUpdateContent />;
}