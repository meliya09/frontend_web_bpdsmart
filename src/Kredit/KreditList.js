...
import KreditCreate from "./KreditCreate";
...
export default function KreditList() {
  const classes = useStyles();
  const [dbo_konten, setKredit] = useState([]);
  ...
  const getKredit = async () => {
    const dbo_konten = await axios.get('http://192.168.100.215:8080/kredit');
    setKredit(dbo_konten.data);

  }

  const UpdateKredit = async (id) => {
    navigate(`/updatekredit/${id}`);
  };

  const KreditDelete = async (id) => {
    await axios.delete(`http://192.168.100.215:8080/kredit/${id}`);
    getKredit();
  };

  const getDetail = async (id) => {
    navigate(`/kredit/detailkredit/${id}`);
  };
              ...
              <Paper>
                <Box>
                  ...
                  >
                    ...
                    <KreditCreate create={create} handleCloseCreate={handleCloseCreate} />
                        ...
                        >
                          ...
                          <TableCell align="center">
                            <ButtonGroup color="primary" aria-label="outlined primary button group">
                              ...
                              <Button startIcon={<EditIcon />} color="success" onClick={() => UpdateKredit(konven.konten_id)}>
                              </Button>
