...
import KreditUpdate from '../Kredit/KreditUpdate';
...
function KreditKonvenUpdateContent() {
...
export default function KreditUpdateContent() {
  return <KreditKonvenUpdateContent />;
}