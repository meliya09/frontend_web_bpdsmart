...
export default function GiroSyariahCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/girosyariah', {
            ...
            .then(res => {
                ...
                window.location.href = "/girosyariah";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Giro Syariah</DialogTitle>
                <DialogContent>
