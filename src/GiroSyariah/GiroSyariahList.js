...
import GiroSyariahCreate from "./GiroSyariahCreate";
...
export default function GiroSyariahList() {
  ...
  const getGiroSyariah = async () => {
    const dbo_konten = await axios.get('http://192.168.100.215:8080/girosyariah');
    setSyariah(dbo_konten.data);

  }

  // const editGiroSyariah = async () => {
  //   const dbo_konten = await axios.get('http://192.168.100.215:8080/girosyariah/:id')
  //   setSyariah(dbo_konten.data);

  // }

  const UpdateGiroSyariah = async (id) => {
    navigate(`/updategirosyariah/${id}`);
  };

  const GiroSyariahDelete = async (id) => {
    await axios.delete(`http://192.168.100.215:8080/jasasyariah/${id}`);
    getGiroSyariah();
  };

  const getDetail = async (id) => {
    navigate(`/girosyariah/detailgirosyariah/${id}`);
  };
              ...
              <Paper>
                <Box>
                  ...
                  >
                    ...
                    <GiroSyariahCreate create={create} handleCloseCreate={handleCloseCreate} />
                        ...
                        >
                          ...
                          <TableCell align="center">
                            <ButtonGroup color="primary" aria-label="outlined primary button group">
                              ...
                              <Button startIcon={<EditIcon />} color="success" onClick={() => UpdateGiroSyariah(syariah.konten_id)}>
                              </Button>
                              ...
                              <Button startIcon={<DeleteIcon />} color="error"
                                onClick={() =>
                                  swal({
                                    ...
                                    if (result) {
                                      GiroSyariahDelete(syariah.konten_id);
                                      swal({
                                        title: "Deleted!",
