...
import GiroSyariahUpdate from '../GiroSyariah/GiroSyariahUpdate';
...
function GiroSyarUpdateContent() {
...
export default function GiroSyariahUpdateContent() {
  return <GiroSyarUpdateContent />;
}