...
import KreditProduktifCreate from "./KreditProduktifCreate";
...
export default function KreditProduktifList() {
  const classes = useStyles();
  const navigate = useNavigate();
  const [dbo_konten, setKreditProduktif] = useState([]);
  ...
  const getKreditProduktif = async () => {
    const dbo_konten = await axios.get("http://192.168.100.215:8080/kreditproduktif");
    setKreditProduktif(dbo_konten.data);
  }

  const getDetail = async (id) => {
    navigate(`/kreditproduktif/detailkreditproduktif/${id}`);
  };
  
  const UpdateKreditProduktif = async (id) => {
    navigate(`/updatekreditproduktif/${id}`);
  };

  const KreditProduktifDelete = async (id) => {
    await axios.delete(`http://192.168.100.215:8080/kreditproduktif/${id}`);
    getKreditProduktif();
  };
              ...
              <Paper>
                <Box>
                  ...
                  >
                    ...
                    <KreditProduktifCreate create={create} handleCloseCreate={handleCloseCreate} />
                        ...
                        >
                          ...
                          <TableCell align="center">
                            <ButtonGroup color="primary" aria-label="outlined primary button group">
                              ...
                              <Button startIcon={<EditIcon />} color="success" onClick={() => UpdateKreditProduktif(konven.konten_id)}>
                              </Button>
                              ...
                              <Button startIcon={<DeleteIcon />} color="error"
                                onClick={() =>
                                  swal({
                                    ...
                                    if (result) {
                                      KreditProduktifDelete(konven.konten_id);
                                      swal({
                                        title: "Deleted!",
