...
import KreditProduktifList from '../KreditProduktif/KreditProduktifList';
...
function KreditProduktifContent() {
...
export default function KreditProduktif() {
  return <KreditProduktifContent />;
}