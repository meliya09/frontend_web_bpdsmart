...
export default function KreditProduktifCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/kreditproduktif', {
            ...
            .then(res => {
                ...
                window.location.href = "/kreditproduktif";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Kredit Produktif</DialogTitle>
                <DialogContent>
