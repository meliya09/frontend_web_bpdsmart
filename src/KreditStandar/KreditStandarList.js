...
import KreditStandarCreate from "./KreditStandarCreate";
...
export default function KreditStandarList() {
  const classes = useStyles();
  const navigate = useNavigate();
  const [dbo_konten, setKreditStandar] = useState([]);
  ...
  const getKreditStandar = async () => {
    const dbo_konten = await axios.get("http://192.168.100.215:8080/kreditstandar");
    setKreditStandar(dbo_konten.data);
  }

  const getDetail = async (id) => {
    navigate(`/kreditstandar/detailkreditstandar/${id}`);
  }; 

  const UpdateKreditStandar = async (id) => {
    navigate(`/updatekreditstandar/${id}`);
  };
  ...
  const KreditStandarDelete = async (id) => {
    await axios.delete(`http://192.168.100.215:8080/kreditstandar/${id}`);
    getKreditStandar();
  };
  return (
    <>
              ...
              <Paper>
                <Box>
                  ...
                  >
                    ...
                    <KreditStandarCreate create={create} handleCloseCreate={handleCloseCreate} />
                        ...
                        >
                          ...
                          <TableCell align="center">
                            <ButtonGroup color="primary" aria-label="outlined primary button group">
                              ...
                              <Button startIcon={<EditIcon />} color="success" onClick={() => UpdateKreditStandar(konven.konten_id)}>
                              </Button>
                              ...
                              <Button startIcon={<DeleteIcon />} color="error"
                                onClick={() =>
                                  swal({
                                    ...
                                    if (result) {
                                      KreditStandarDelete(konven.konten_id);
                                      swal({
                                        title: "Deleted!",
