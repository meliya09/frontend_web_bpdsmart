...
export default function KreditStandarCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/kreditstandar', {
            ...
            .then(res => {
                ...
                window.location.href = "/kreditstandar";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Kredit Standar</DialogTitle>
                <DialogContent>
