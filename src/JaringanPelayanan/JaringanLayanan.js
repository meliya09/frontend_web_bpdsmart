...
import JaringanLayananList from '../JaringanPelayanan/JaringanLayananList';
...
function JaringanLayananContent() {
...
export default function JaringanLayanan() {
  return <JaringanLayananContent />;
}