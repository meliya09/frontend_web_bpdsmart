...
export default function KreditKonsumerCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/kreditkonsumer', {
            ...
            .then(res => {
                ...
                window.location.href = "/kreditkonsumer";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Kredit Konsumer</DialogTitle>
                <DialogContent>
