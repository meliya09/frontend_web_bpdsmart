...
import KreditKonsumerCreate from "./KreditKonsumerCreate";
...
export default function KreditKonsumerList() {
  const classes = useStyles();
  const navigate = useNavigate();
  const [dbo_konten, setKreditKonsumer] = useState([]);
  ...
  const getKreditKonsumer = async () => {
    const dbo_konten = await axios.get("http://192.168.100.215:8080/kreditkonsumer");
    setKreditKonsumer(dbo_konten.data);
  }

  const getDetail = async (id) => {
    navigate(`/kreditkonsumer/detailkreditkonsumer/${id}`);
  };

  const UpdateKreditKonsumer = async (id) => {
    navigate(`/updatekreditkonsumer/${id}`);
  };
  ...
  const KreditKonsumerDelete = async (id) => {
    await axios.delete(`http://192.168.100.215:8080/kreditkonsumer/${id}`);
    getKreditKonsumer();
  };
              ...
              <Paper>
                <Box>
                  ...
                  >
                    ...
                    <KreditKonsumerCreate create={create} handleCloseCreate={handleCloseCreate} />
                        ...
                        >
                          ...
                          <TableCell align="center">
                            <ButtonGroup color="primary" aria-label="outlined primary button group">
                              ...
                              <Button startIcon={<EditIcon />} color="success" onClick={() => UpdateKreditKonsumer(konven.konten_id)} >
                              </Button>
                              ...
                              <Button startIcon={<DeleteIcon />} color="error"
                                onClick={() =>
                                  swal({
                                    ...
                                    if (result) {
                                      KreditKonsumerDelete(konven.konten_id);
                                      swal({
                                        title: "Deleted!",
