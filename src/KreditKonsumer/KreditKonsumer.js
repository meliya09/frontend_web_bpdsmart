...
import KreditKonsumerList from '../KreditKonsumer/KreditKonsumerList';
...
function KreditKonsumerContent() {
...
export default function KreditKonsumer() {
  return <KreditKonsumerContent />;
}