...
import GiroKonvenUpdate from '../GiroKonven/GiroKonvenUpdate';
...
function GiroKonvenUpdateContent() {
...
export default function GiroKonUpdateContent() {
  return <GiroKonvenUpdateContent />;
}