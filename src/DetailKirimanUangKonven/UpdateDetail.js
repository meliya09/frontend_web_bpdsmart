...
export default function UpdateDetail({ open, handleClose }) {
    ...
    const getDetailById = async () => {
        const response = await axios.get(`http://192.168.100.215:8080/detailkirimanuang/${id}`);
    ...
    const updateDetail = async (e) => {
        ...
        try {
            await axios.post(`http://192.168.100.215:8080/detailkirimanuang/update/${id}`, formData, {
                headers: {
                ...
                .then(res => {
                    ...
                    window.location = '/kirimanuang/detailkirimanuang/' + id
                })
        } catch (error) {
            console.log(error);
        }
        try {
            await axios.post(`http://192.168.100.215:8080/detailkirimanuang/update2/${id}`, formData, {
                headers: {
                    "Content-type": "multipart/form-data",
                },
            })
        ...
        try {
            await axios.post(`http://192.168.100.215:8080/detailkirimanuang/update3/${id}`, formData, {
                headers: {
                    "Content-type": "multipart/form-data",
                },
            })
