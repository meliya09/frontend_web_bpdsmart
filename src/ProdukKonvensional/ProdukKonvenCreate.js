...
export default function ProdukKonvenCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/konven', {
            ...
            .then(res => {
                ...
                window.location.href = "/produkkonven";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Produk Konven</DialogTitle>
                <DialogContent>
