...
import ProdukKonvenCreate from "./ProdukKonvenCreate";
...
export default function ProdukKonvenList() {
  ...
  const getKonven = async () => {
    const dbo_konten = await axios.get('http://192.168.100.215:8080/konven');
    setKonven(dbo_konten.data);

  }

  const UpdateKonven = async (id) => {
    navigate(`/updatekonven/${id}`);
  };
  const KonvenDelete = async (id) => {
    await axios.delete(`http://192.168.100.215:8080/konven/${id}`);
    getKonven();
  };
              ...
              <Paper>
                <Box>
                  ...
                  >
                    ...
                    <ProdukKonvenCreate create={create} handleCloseCreate={handleCloseCreate} />
                  </Box>
                </Box>
                <br />
