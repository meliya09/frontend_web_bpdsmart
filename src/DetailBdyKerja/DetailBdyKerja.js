...
import DetailBdyKerjaList from '../DetailBdyKerja/DetailBdyKerjaList';
...
function DetailBdyKerjaContent() {
...
export default function DetailBdyKerja() {
  return <DetailBdyKerjaContent />;
}