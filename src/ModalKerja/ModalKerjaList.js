...
import ModalKerjaCreate from "./ModalKerjaCreate";
...
export default function ModalKerjaList() {
  const classes = useStyles();
  const navigate = useNavigate();

  const [dbo_konten, setModalKerja] = useState([]);
  ...
  const getModalKerja = async () => {
    const dbo_konten = await axios.get('http://192.168.100.215:8080/modalkerja');
    setModalKerja(dbo_konten.data);

  }

  const ModalKerjaUpdate = async (id) => {
    navigate(`/updatemodalkerja/${id}`);
  };

  const ModalKerjaDelete = async (id) => {
    await axios.delete(`http://192.168.100.215:8080/modalkerja/${id}`);
    getModalKerja();
  };
  const getDetail = async (id) => {
    navigate(`/modalkerja/detailmodalkerja/${id}`);
  };
              ...
              <Paper>
                <Box>
                  ...
                  >
                    ...
                    <ModalKerjaCreate create={create} handleCloseCreate={handleCloseCreate} />
                        ...
                        >
                          ...
                          <TableCell align="center">
                            <ButtonGroup color="primary" aria-label="outlined primary button group">
                              ...
                              <Button startIcon={<EditIcon />} color="success" onClick={() => ModalKerjaUpdate(syariah.konten_id)} >
                              </Button>
                              ...
                              <Button startIcon={<DeleteIcon />} color="error"
                                onClick={() =>
                                  swal({
                                    ...
                                    if (result) {
                                      ModalKerjaDelete(syariah.konten_id);
                                      swal({
                                        title: "Deleted!",
