...
export default function ModalKerjaCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/modalkerja', {
            ...
            .then(res => {
                ...
                window.location.href = "/modalkerja";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Modal Kerja</DialogTitle>
                <DialogContent>
