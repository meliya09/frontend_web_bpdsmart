...
export default function UpdateDetail({ open, handleClose }) {
    ...
    const getDetailById = async () => {
        const response = await axios.get(`http://192.168.100.215:8080/detailkreditkonsumer/${id}`);
    ...
    const updateDetail = async (e) => {
        ...
        try {
            await axios.post(`http://192.168.100.215:8080/detailkreditkonsumer/update/${id}`, formData, {
                headers: {
                ...
                .then(res => {
                    ...
                    window.location = '/kreditkonsumer/detailkreditkonsumer/' + id
                })
        } catch (error) {
            console.log(error);
        }
        try {
            await axios.post(`http://192.168.100.215:8080/detailkreditkonsumer/update2/${id}`, formData, {
                headers: {
                    "Content-type": "multipart/form-data",
                },
            })
        ...
        try {
            await axios.post(`http://192.168.100.215:8080/detailkreditkonsumer/update3/${id}`, formData, {
                headers: {
                    "Content-type": "multipart/form-data",
                },
            })
