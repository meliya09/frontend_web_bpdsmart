...
import InfoDetail from '../DetailInternal/InfoDetail';
...
function DetailInternalInfoContent() {
...
export default function DetailInternalInfo() {
  return <DetailInternalInfoContent />;
}