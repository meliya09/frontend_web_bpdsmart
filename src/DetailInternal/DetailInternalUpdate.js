...
import FormUpdate from '../DetailInternal/FormUpdate';
...
function DetailInternalUpdateContent() {
...
export default function DetailInternalUpdate() {
  return <DetailInternalUpdateContent />;
}