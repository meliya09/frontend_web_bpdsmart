...
import DetailInternalList from '../DetailInternal/DetailInternalList';
...
function DetailInternalContent() {
...
export default function DetailInternal() {
  return <DetailInternalContent />;
}