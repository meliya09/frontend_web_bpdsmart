...
export default function TabSyariahCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://192.168.100.215:8080/tabsyariah', {
            ...
            .then(res => {
                ...
                window.location.href = "/tabsyariah";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Tabungan Syariah</DialogTitle>
                <DialogContent>
