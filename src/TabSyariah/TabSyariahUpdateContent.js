...
import TabSyariahUpdate from '../TabSyariah/TabSyariahUpdate';
...
export default function TabSyariahUpdateContent() {
  return <TabSyarUpdateContent />;
}