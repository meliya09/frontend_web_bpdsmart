...
export default function DanaKonvenCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/danakonven', {
            ...
            .then(res => {
                ...
                window.location.href = "/danakonven";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Dana Konven</DialogTitle>
                <DialogContent>
