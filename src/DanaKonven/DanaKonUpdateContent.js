...
import DanaKonvenUpdate from '../DanaKonven/DanaKonvenUpdate';
...
function DanaKonvenUpdateContent() {
...
export default function DanaKonUpdateContent() {
  return <DanaKonvenUpdateContent />;
}