...
export default function DepositoKonvenCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/depositokonven', {
            ...
            .then(res => {
                ...
                window.location.href = "/depositokonven";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Deposito Konven</DialogTitle>
                <DialogContent>
