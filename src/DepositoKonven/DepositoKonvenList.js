...
import DepositoKonvenCreate from "./DepositoKonvenCreate";
...
export default function DepoKonvenList() {
  const classes = useStyles();
  const navigate = useNavigate();
  const [dbo_konten, setDepoKonven] = useState([]);
  ...
  const getDepoKonven = async () => {
    const dbo_konten = await axios.get('http://192.168.100.215:8080/depositokonven');
    setDepoKonven(dbo_konten.data);
  }

  const getDetail = async (id) => {
    navigate(`/depositokonven/detaildepokonven/${id}`);
  };

  const UpdateDepositoKonven = async (id) => {
    navigate(`/updatedepkonven/${id}`);
  };

  const DepositoKonvenDelete = async (id) => {
    await axios.delete(`http://192.168.100.215:8080/depositokonven/${id}`);
    getDepoKonven();
  };
              ...
              <Paper>
                <Box>
                  ...
                  >
                    ...
                    <DepositoKonvenCreate create={create} handleCloseCreate={handleCloseCreate} />
                        ...
                        >
                          ...
                          <TableCell align="center">
                            <ButtonGroup color="primary" aria-label="outlined primary button group">
                              ...
                              <Button startIcon={<EditIcon />} color="success" onClick={() => UpdateDepositoKonven(konven.konten_id)} >
                              </Button>
                              ...
                              <Button startIcon={<DeleteIcon />} color="error"
                                onClick={() =>
                                  swal({
                                    ...
                                    if (result) {
                                      DepositoKonvenDelete(konven.konten_id);
                                      swal({
                                        title: "Deleted!",
