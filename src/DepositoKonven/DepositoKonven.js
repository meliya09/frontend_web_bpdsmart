...
import DepositoKonvenList from '../DepositoKonven/DepositoKonvenList';
...
function DepositoKonvenContent() {
...
export default function DepositoKonven() {
  return <DepositoKonvenContent />;
}