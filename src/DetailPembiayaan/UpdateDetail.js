...
export default function UpdateDetail({ open, handleClose }) {
    ...
    const getDetailById = async () => {
        const response = await axios.get(`http://192.168.100.215:8080/detailpembiayaan/${id}`);
    ...
    const updateDetail = async (e) => {
        ...
        try {
            await axios.post(`http://192.168.100.215:8080/detailpembiayaan/update/${id}`, formData, {
                headers: {
                ...
                .then(res => {
                    ...
                    window.location = '/pembiayaan/detailpembiayaan/' + id
                })
        } catch (error) {
            console.log(error);
        }
        try {
            await axios.post(`http://192.168.100.215:8080/detailpembiayaan/update2/${id}`, formData, {
                headers: {
                    "Content-type": "multipart/form-data",
                },
            })
        ...
        try {
            await axios.post(`http://192.168.100.215:8080/detailpembiayaan/update3/${id}`, formData, {
                headers: {
                    "Content-type": "multipart/form-data",
                },
            })
