...
export default function KirimanUangKonvenCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/kirimanuangkonven', {
            ...
            .then(res => {
                ...
                window.location.href = "/kirimanuang";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Kiriman Uang Konven</DialogTitle>
                <DialogContent>
