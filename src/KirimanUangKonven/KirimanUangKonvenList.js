...
import KirimanUangKonvenCreate from "./KirimanUangKonvenCreate";
...
export default function KirimanUangKonvenList() {
  const classes = useStyles();
  const navigate = useNavigate();
  const [dbo_konten, setKUKonven] = useState([]);
  ...
  const getKUKonven = async () => {
    const dbo_konten = await axios.get("http://192.168.100.215:8080/kirimanuangkonven");
    setKUKonven(dbo_konten.data);
  }

  const getDetail = async (id) => {
    navigate(`/kirimanuang/detailkirimanuang/${id}`);
  };

  const UpdateKirimanUangKonven = async (id) => {
    navigate(`/updatekirimuangkonven/${id}`);
  };

  const KirimanUangKonvenDelete = async (id) => {
    await axios.delete(`http://192.168.100.215:8080/kirimanuangkonven/${id}`);
    getKUKonven();
  };
              ...
              <Paper>
                <Box>
                  ...
                  >
                    ...
                    <KirimanUangKonvenCreate create={create} handleCloseCreate={handleCloseCreate} />
                        ...
                        >
                          ...
                          <TableCell align="center">
                            <ButtonGroup color="primary" aria-label="outlined primary button group">
                              ...
                              <Button startIcon={<EditIcon />} color="success" onClick={() => UpdateKirimanUangKonven(konven.konten_id)} >
                              </Button>
                              ...
                              <Button startIcon={<DeleteIcon />} color="error"
                                onClick={() =>
                                  swal({
                                    ...
                                    if (result) {
                                      KirimanUangKonvenDelete(konven.konten_id);
                                      swal({
                                        title: "Deleted!",
