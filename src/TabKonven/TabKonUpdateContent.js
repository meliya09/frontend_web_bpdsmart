...
import TabKonvenUpdate from '../TabKonven/TabKonvenUpdate';
...
function TabKonvenUpdateContent() {
...
export default function TabKonUpdateContent() {
  return <TabKonvenUpdateContent />;
}