...
export default function TabKonvenCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/tabkonven', {
            ...
            .then(res => {
                ...
                window.location.href = "/tabkonven";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Tabungan Konven</DialogTitle>
                <DialogContent>
