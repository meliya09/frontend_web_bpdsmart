...
import InvestasiCreate from "./InvestasiCreate";
...
export default function InvestasiList() {
  ...
  const [dbo_konten, setInvestasi] = useState([]);
  ...
  const getInvestasi = async () => {
    const dbo_konten = await axios.get('http://192.168.100.215:8080/investasi');
    setInvestasi(dbo_konten.data);

  }


  const UpdateInvestasi = async (id) => {
    navigate(`/updateinvestasi/${id}`);
  };

  const InvestasiDelete = async (id) => {
    await axios.delete(`http://192.168.100.215:8080/investasi/${id}`);
    getInvestasi();
  };

  const getDetail = async (id) => {
    navigate(`/investasi/detailinvestasi/${id}`);
  };
              ...
              <Paper>
                <Box>
                  ...
                  >
                    ...
                    <InvestasiCreate create={create} handleCloseCreate={handleCloseCreate} />
                        ...
                        >
                          ...
                          <TableCell align="center">
                            <ButtonGroup color="primary" aria-label="outlined primary button group">
                              ...
                              <Button startIcon={<EditIcon />} color="success" onClick={() => UpdateInvestasi(syariah.konten_id)} >
                              </Button>
                              ...
                              <Button startIcon={<DeleteIcon />} color="error"
                                onClick={() =>
                                  swal({
                                    ...
                                    if (result) {
                                      InvestasiDelete(syariah.konten_id);
                                      swal({
                                        title: "Deleted!",
