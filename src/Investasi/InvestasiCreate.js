...
export default function InvestasiCreate({ create, handleCloseCreate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://192.168.100.215:8080/investasi', {
            ...
            .then(res => {
                ...
                window.location.href = "/investasi";
            })
            .catch(err => {
                console.log(err)
            });
    ...
    return (
        <div className={classes.paper} >
            <Dialog open={create}
                ...
                <DialogTitle id="alert-dialog-title">Add Menu Investasi</DialogTitle>
                <DialogContent>
